...
$string['accesscolnoaccount'] = 'Access without an account';
...
$string['accessloginrefused'] = 'The account could not be signed in. Please contact the course team.';
...
$string['accessorregisterintro'] = 'Would you rather keep your progress right away?';
...
$string['accessregister'] = 'Register for a persistent account';
$string['accesstitle'] = 'Temporary course access';
$string['accesstitlenotemp'] = 'Course access';
$string['accessunavailable'] = 'This course is not available for FlexAccess entry.';
$string['checklifecycle'] = 'FlexAccess account lifecycle';
$string['checklifecycleaction'] = 'Open FlexAccess system status';
$string['checklifecyclemismatch'] = '{$a} FlexAccess account inconsistencies found.';
$string['checklifecycleok'] = 'All FlexAccess accounts are consistent with their lifecycle state.';
$string['eventloginrefused'] = 'FlexAccess login refused';
...
$string['mismatch_active_restricted'] = 'Active account still holds the FlexAccess restriction role';
$string['mismatch_active_suspended'] = 'Active account, but the Moodle user is suspended';
$string['mismatch_live_suspended'] = 'Live temporary or pending account, but the Moodle user is suspended';
$string['mismatch_locked_unsuspended'] = 'Expired or suspended account, but the Moodle user is not suspended';
$string['mismatch_orphan_restriction'] = 'Restriction role held without a FlexAccess account';
$string['mismatch_overdue'] = 'Temporary account past its expiry that has not been expired yet';
$string['mismatch_temporary_unrestricted'] = 'Temporary or pending account without the FlexAccess restriction role';
$string['mismatch_type_state'] = 'Account type and state contradict each other';
...
$string['privacy:metadata:account:batchcredential'] = 'Whether the account holds an issued, reusable credential (an access-list card).';
$string['privacy:metadata:account:lockedby'] = 'Whether the suspension of the Moodle user was set by the FlexAccess lifecycle.';
...
$string['privacy:metadata:preference:pendingcredential'] = 'Time at which an administrative conversion started to wait for the user to set a password.';
...
$string['settingrecoverylifetime'] = 'Lifetime of a recovered account';
$string['settingrecoverylifetime_desc'] = 'How long a frozen temporary account stays valid after an administrator or teacher has recovered it. An account waiting for e-mail verification receives a new verification link and becomes permanent only when that link is followed.';
