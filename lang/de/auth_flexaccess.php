...
$string['access:colaccount'] = 'Zugang mit Account';
$string['access:coltemporary'] = 'Temporärer Gastaccount';
...
$string['access:guestlimitations'] = 'Als Gast können Sie den Kurs nur ansehen. Sie können nichts abgeben, keine Tests bearbeiten, nicht in Foren schreiben und keinen Fortschritt speichern.';
...
$string['access:noaccountoptions'] = 'Kontobasierter Zugang ist für diesen Kurs nicht verfügbar.';
...
$string['persisthint:cta'] = 'Zugang jetzt dauerhaft sichern';
$string['persisthint:text'] = 'Sie nutzen einen temporären Zugang zu diesem Kurs. Ihr Fortschritt kann dauerhaft gesichert werden.';
...
$string['setpassword:emailbody'] = 'Eine Administratorin/ein Administrator hat Ihr Konto aktiviert. Legen Sie zum Abschluss Ihr Passwort fest und melden Sie sich über diesen Link an (er läuft bald ab): {$a}';
$string['setpassword:emailsubject'] = 'Konto aktivieren: Passwort festlegen';
$string['setpassword:intro'] = 'Ihr Konto wurde von einer Administratorin/einem Administrator aktiviert. Wählen Sie ein Passwort, um die Einrichtung abzuschließen und sich anzumelden.';
$string['setpassword:invalid'] = 'Dieser Link zum Festlegen des Passworts ist ungültig oder abgelaufen. Bitte lassen Sie ihn erneut senden.';
$string['setpassword:mismatch'] = 'Die beiden Passwörter stimmen nicht überein.';
$string['setpassword:password'] = 'Neues Passwort';
$string['setpassword:password2'] = 'Passwort bestätigen';
$string['setpassword:submit'] = 'Passwort festlegen und anmelden';
$string['setpassword:success'] = 'Ihr Passwort wurde festgelegt. Sie sind jetzt angemeldet.';
$string['setpassword:title'] = 'Passwort festlegen';
...
$string['setting:followupwindow'] = 'Erinnerungsfenster für Persistenz';
$string['setting:followupwindow_desc'] = 'Wie lange vor Ablauf eines temporären Kontos eine einmalige Erinnerung an Nutzer gesendet wird, die die E-Mail-Verifizierung begonnen, aber nicht abgeschlossen haben. Null deaktiviert die Erinnerungen.';
...
$string['settings:accounts_desc'] = 'Konto-Laufzeiten werden pro Kurs an der FlexAccess-Einschreibemethode konfiguriert, nicht hier.';
